...
function setup() {
	...
	box1Sprite=createSprite(365,675,220,20)
	box1Sprite.shapeColor=color("RED")

	box2Sprite=createSprite(265,615,20,120)
	box2Sprite.shapeColor=color("RED")

	box2Sprite=createSprite(465,615,20,120)
	box2Sprite.shapeColor=color("RED")
	 ...
	 box1= Bodies.rectangle(350, 650, 195, 10 , {isStatic:true} );
